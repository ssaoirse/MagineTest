...
open class SwiftOverlays: NSObject {
    ...
    */
    ...
    open class func showGenericOverlay(_ parentView: UIView, text: String, accessoryView: UIView, horizontalLayout: Bool = false) -> UIView {
    ...
    fileprivate class func labelForText(_ text: String) -> UILabel {
        ...
        let textSize = text.size(withAttributes: [kCTFontAttributeName as NSAttributedStringKey: font])
            ...
            //text.size(attributes: [NSFontAttributeName: font])
